                ...
                <div className="row">
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info groom-info">
                            <h3>
                                R. Mehboob Basha <sub>B.Com., C.A.,</sub>
                            </h3>
                            <p className="mt-2 mt-lg-3">
                                Proprietor: <strong>R.R. Jewellers,</strong>
                            ...
                            <p className="mt-1 mt-lg-2">
                                ...
                                <strong>
                                    Raichur Abdul Saleem Sahab(Late),
                                </strong>{" "}
                            </p>
                            <p className="mt-1 mt-lg-2">
                                Maternal Grand S/O Janab{" "}
                                <strong>
                                    Maistry Abdul Rawoof Sahab, Gold Smith(Late).
                                </strong>{" "}
                            </p>
                            {/* <p className="mt-1 mt-lg-2">
                                Retd. Head Master,
                    ...
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info bride-info">
                            ...
                            <p className="mt-2 mt-lg-3">
                                Eldest D/O Janab{" "}
                                <strong>N. Ifthekar Ahmed Sahab,</strong>
                            </p>
                            <p className="mt-1 mt-lg-2">
                                <strong>Naaz Automobiles,</strong>
                            </p>
                            {/* <p className="mt-1 mt-lg-2">
                                Eldest D/O Janab{" "}
                            ...
                            <p className="mt-1 mt-lg-2">
                                Residence: Near Vivekananda Jr. College,
                            </p>
                            <p className="mt-1 mt-lg-2">NGO's Colony, Adoni.</p>
